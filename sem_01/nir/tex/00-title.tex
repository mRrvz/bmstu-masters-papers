\begin{titlepage}
	...
	\begin{table}[h!]
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Студент группы \textbf{ИУ7-12М} & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{А. В. Романов} \hfill} \\
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Руководитель НИР & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{А. А. Оленев} \hfill} \\
			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
		\end{signstabular}
